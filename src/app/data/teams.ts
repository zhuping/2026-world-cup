...
export const knockoutRounds: BracketRound[] = [
  ...
  },
  {
    ...
    matches: [
      match('r16-1', {
        team1: bracketTeam('🇵🇾', '巴拉圭', 'Paraguay'),
        team2: bracketTeam('🇫🇷', '法国', 'France'),
        date: '2026-07-04',
      ...
      match('r16-3', {
        team1: bracketTeam('🇪🇸', '西班牙', 'Spain'),
        team2: bracketTeam('🇵🇹', '葡萄牙', 'Portugal'),
        date: '2026-07-06',
        venue: 'AT&T Stadium, Dallas',
      }),
      match('r16-4', {
        team1: bracketTeam('🇧🇪', '比利时', 'Belgium'),
        team2: bracketTeam('🇺🇸', '美国', 'USA'),
        date: '2026-07-07',
        venue: 'Lumen Field, Seattle',
      }),
      match('r16-5', {
      ...
      match('r16-6', {
        ...
        date: '2026-07-06',
        venue: 'Estadio Banorte, Monterrey',
      }),
      match('r16-7', {
        team1: bracketTeam('🇦🇷', '阿根廷', 'Argentina'),
        team2: bracketTeam('🇪🇬', '埃及', 'Egypt'),
      ...
      match('r16-8', {
        team1: bracketTeam('🇨🇭', '瑞士', 'Switzerland'),
        team2: bracketTeam('🇨🇴', '哥伦比亚', 'Colombia'),
        date: '2026-07-07',
        venue: 'BC Place, Vancouver',
      }),
    ],
