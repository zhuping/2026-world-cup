...
export async function generateMetadata({ params }: { params: { lang: string } }): Promise<Metadata> {
  return buildMetadata({ locale: params.lang, path: '/venues/estadio-azteca', pageKey: 'azteca' });
}
...
export default function EstadioAztecaPage({ params }: { params: { lang: string } }) {
  ...
  const breadcrumb = {
    ...
    itemListElement: [
      ...
      { '@type': 'ListItem', position: 3, name: copy.h1, item: buildUrl(lang, '/venues/estadio-azteca') },
    ],
  };
